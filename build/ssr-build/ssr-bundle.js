...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__("5h+a")(module)))
		...
		return Object(preact_min["h"])(
			...
			Object(preact_min["h"])(
				...
				Object(preact_min["h"])(
					...
					null,
					new Date(state.createdOn).toDateString()
				)
			)
		);
	};
...
var articleList_ArticleList = function (_Component) {
	...
	ArticleList.prototype.render = function render(props, state) {
		var merge = this.mergeNewArticles;
		var updateButton = Object(preact_min["h"])(
			preact_material_components_Button,
			{ className: 'mdc-button mdc-button--raised', onClick: merge },
			'Load ',
